...
public class Guarderia {
    ...
    void cargarDatosTablaEmpleados() {
        ...
        for (Empleado empleado : conjuntoEmpleados) {
            if (empleado.getPuesto() == Puesto.GUARDERIA) {
    ...
    void cargarDatosTablaClientes() {
        ...
        for (Cliente cliente : listaClientes) {
            if (cliente.getServicio() == Servicio.GUARDERIA || cliente.getServicio() == Servicio.GUARDERIA_Y_SPA) {
    ...
    public void setVisible(boolean visible) {
        JFrame frame = new JFrame("Guardería");
